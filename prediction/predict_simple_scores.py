...
def find_line(image, points, predictionComplexScores, threshold):
    ...
    pat3 = pattern3.Pattern3(img, drawing, retrieveModel('rett_diag_model.joblib'),  retrieveModel('rett_diag_scaler.joblib'), retrieveModel('rett_diag_score_model_aug.joblib'), retrieveModel('rett_diag_score_scaler_aug.joblib'), predictionComplexScores)
    drawing, results[2]['label'] = pat3.get_score(ret_fig, diag1, diag2, oriz_coord, threshold)
    results[2]['roi'] = pat3.get_ROI()   
    
    pat5 = pattern5.Pattern5(img, drawing, retrieveModel('cross_model.joblib'), retrieveModel('cross_scaler.joblib'), retrieveModel('cross_score_model_aug.joblib'), retrieveModel('cross_score_scaler_aug.joblib'), predictionComplexScores)
    ...
    pat10 = pattern10.Pattern10(img, drawing, retrieveModel('face_model.joblib'), retrieveModel('face_scaler.joblib'), retrieveModel('face_score_model_aug.joblib'), retrieveModel('face_score_scaler_aug.joblib'), predictionComplexScores)
    ...
    pat12 = pattern12.Pattern12(img, drawing, retrieveModel('rail_model.joblib'), retrieveModel('rail_scaler.joblib'), retrieveModel('rail_score_model_aug.joblib'), retrieveModel('rail_score_scaler_aug.joblib'), predictionComplexScores)
    ...
    pat15 = pattern15.Pattern15(img, drawing, retrieveModel('rect_model.joblib'), retrieveModel('rect_scaler.joblib'), retrieveModel('rect_score_model_aug.joblib'), retrieveModel('rect_score_scaler_aug.joblib'), predictionComplexScores)
    ...
    pat17 = pattern17.Pattern17(img, drawing, retrieveModel('cross_vert_model.joblib'), retrieveModel('cross_vert_scaler.joblib'), retrieveModel('cross_vert_score_model_aug.joblib'), retrieveModel('cross_vert_score_scaler_aug.joblib'), predictionComplexScores)
    drawing, results[16]['label'] = pat17.get_score()
    results[16]['roi'] = pat17.get_ROI() 

    pat18 = pattern18.Pattern18(img, drawing, retrieveModel('triang_model.joblib'), retrieveModel('triang_scaler.joblib'), retrieveModel('triang_score_model_aug.joblib'), retrieveModel('triang_score_scaler_aug.joblib'), predictionComplexScores)
